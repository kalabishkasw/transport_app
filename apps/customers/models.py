"""
модель клієнта компанії (юр. та фіз. особи).

зберігаю реквізити (ЄДРПОУ, VAT), країну і адресу, контактні дані, умови
оплати. опційно привязую до користувача порталу через portal_user
(OneToOne з User), що дає клієнту доступ до особистого кабінету.
"""
