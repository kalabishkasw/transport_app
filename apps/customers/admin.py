"""
адмінка клієнтів-компаній.

списки з фільтрами за країною і активністю, пошук за реквізитами і контактами,
згруповані fieldsets для основної інформації, адреси, контактів і кабінету.
"""
